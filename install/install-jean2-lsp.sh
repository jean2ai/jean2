...
VERSION_FILE_URL="https://raw.githubusercontent.com/rabbyte-tech/jean2/refs/heads/main/services/lsp/VERSION"
REPO="rabbyte-tech/jean2"
INSTALL_DIR="${HOME}/.jean2/bin"
BINARY_NAME="jean2-lsp"
BINARY_PATH=""
...
download_binary() {
  local url="https://github.com/${REPO}/releases/download/lsp%2Fv${VERSION}/jean2-lsp-${OS}"

  info "Downloading Jean2 LSP for $OS..."
  info "URL: $url"
...
configure_path() {
  ...
  info "Adding Jean2 LSP to PATH in $shell_config..."

  {
    echo ""
    echo "$path_line"
  } >> "$shell_config" && success "Added Jean2 LSP to PATH in $shell_config" || warn "Failed to update $shell_config"
}
