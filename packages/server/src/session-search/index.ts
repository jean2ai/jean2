...
export type { SessionSearchResult } from './session-search-tool';
...
Search results are snippets; use read-around mode with sessionId + aroundMessageId when exact surrounding context is needed.
